...
class Cellule:
    ...
    def __init__(self, nom, matrice, voisine, position_x, partie_mobile, smalt, serrures, porte, transformateur, longueur, coffret, eclisse, boite_eclisse, source, largeur, statut, position_y):
        self.nom = nom
        ...
        self.eclisse = eclisse
        self.boite_eclisse = boite_eclisse
        self.source = source
